...
# --- WICHTIGE KORREKTUR DER IMPORTS ---
# Da diese Datei im Ordner 'sulee' liegt, wir aber vom Root aus starten,
# müssen wir den Ordnernamen voranstellen ('sulee.').

from sulee.wissen import Wissen
from sulee.status_manager import StatusManager
from sulee.engine import SuleeEngine
# Falls du noch andere Dateien aus dem Ordner importierst, immer 'sulee.' davor.
